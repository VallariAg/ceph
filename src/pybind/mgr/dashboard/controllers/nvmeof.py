    ...
    class NVMeoFSubsystem(RESTController):
        ...
        @EndpointDoc(
            ...
            parameters={
                ...
                "gw_group": Param(str, "NVMeoF gateway group", True, None),
                "server_address": Param(str, "NVMeoF gateway address", True, None),
                "network_mask": Param(List[str], "Netmask to automatically create listeners", True, None),
            },
        )
        ...
        @empty_response
        @NvmeofCLICommand("nvmeof subsystem add_network", model.RequestStatus,
                          success_message_template="Adding network mask for subsystem {nqn}: Successful")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        ...
        @empty_response
        @NvmeofCLICommand("nvmeof subsystem del_network", model.RequestStatus,
                          success_message_template="Deleting network mask for subsystem {nqn}: Successful")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
